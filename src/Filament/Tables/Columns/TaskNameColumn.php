...
class TaskNameColumn extends Column implements HasEmbeddedView
{
    public function toEmbeddedHtml(): string
    {
        ...
        <div class="task-name-column">
            ...
            <div class="task-name-icon">
                <span wire:click="openConversation('<?= $this->getRecord()->id ?>')" class=" cursor-pointer">
                    <svg viewBox="0 0 20 20" fill="currentColor" width="22" height="22" aria-hidden="true"
                         class="icon_d382d01cfb conversation-cta-module_withoutUpdates__LoZDn noFocusStyle_89e6d2cbe5"
                         data-testid="icon" data-vibe="Icon"><path
                            ...
                            fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"></path><path
